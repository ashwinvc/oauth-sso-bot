...
class TeamsActivityHandler extends botbuilder_core_1.ActivityHandler {
                ...
                if (!context.activity.name && context.activity.channelId === 'msteams') {
                    ...
                    switch (context.activity.name) {
                        ...
                        case 'adaptiveCard/action':
                            return botbuilder_core_1.ActivityHandler.createInvokeResponse(yield this.handleAdaptiveCardAction(context));
                        case 'signin/verifyState':
                        case 'signin/tokenExchange':
                            return botbuilder_core_1.ActivityHandler.createInvokeResponse(yield this.onSignInInvoke(context));
                        default:
                            runEvents = false;
     ...
     * @returns A Tab Response for the request.
     */
    handleTeamsTabSubmit(context, tabSubmit) {
        return __awaiter(this, void 0, void 0, function* () {
            throw new Error('NotImplemented');
        });
    }
